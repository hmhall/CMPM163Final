    ...
    {        
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 aberrationRed = float2(0.006*_SinTime.y, 0.0)*1.3;
                float2 aberrationGreen = float2(0.0073*cos(_Time.y*0.97), 0.0)*1.3;
                col.r=tex2D(_MainTex, i.uv+_MainTex_TexelSize.x*aberrationRed);
                col.g=tex2D(_MainTex, i.uv+_MainTex_TexelSize.x*aberrationGreen);
